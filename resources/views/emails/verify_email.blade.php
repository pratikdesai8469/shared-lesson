...
<html lang="en" >
   <head>
      <meta charset="UTF-8">
      <title>Verify Your Email on Lession Learning</title>
   </head>
   <body>
      <head>
                                                                   ...
                                                                   <tbody>
                                                                      <tr>
                                                                         <td>
                                                                            <p style="Margin:0; font-size:18px; line-height:23px; color:#102231; font-weight:bold;">
                                                                               <strong>
                                                                               Hi
                                                                                {{ ucwords(strtolower($name)) }},</strong><br><br>
                                                                            </p>
                                                                         </td>
                                                                      </tr>
                                                                      <tr>
                                                                      ...
                                                                      <tr>
                                                                         <td style="padding-top:30px;">
                                                                            ...
                                                                            <p style="Margin:20px 0; font-size:12px; line-height:17px; word-wrap:break-word; word-break:break-all;"><a href="{{ $url }}" style="color:#5885ff; text-decoration:underline;" target="_blank">{{ $url }}</a></p>
                                                                         </td>
                                                                      </tr>
                                                                   </tbody>
                                                                </table>
