                ...
                <div class="p-5 rounded box-shadow">
                    ...
                    <form class="row lession-form">
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" name="s_date" id="s_date" class="form-control dateJs"  value="{{$plan['date']}}"  placeholder="Date" required>
                            ...
                            @foreach($plan['differentiation']['method_name'] as $key=>$row)
                                    <div class="row pl-3 pr-3 pt-2">
                                        <div class="col-lg-2">
                                            ...
                                            {{Form::select('method_data['.$key.'][method_name]',$methodData,!empty($row['method_name']) ? $row['method_name'] : null,['id'=>'method_name','placeholder'=>'Method name', 'class' => 'grade_options method_name'])}}
                                            @if($key == 1)
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            {{Form::select('method_data['.$key.'][method_description]',$methodDescData,!empty($row['method_description']) ? $row['method_description'] : null, ['id'=>'method_description','placeholder'=>'Description', 'class' => 'grade_options method_description'])}}
                                        </div>
                                        <div class="col-lg-2">
                        ...
                        <div class="standard-block mb-5 diffs-div diff-1">
                            <div class="row pl-3 pr-3 pt-3">
                                <div class="col-lg-2">
                                    <label for="method_name">Method name</label>
                                    {{Form::select('method_data[1][method_name]',[],[],['id'=>'method_name','placeholder'=>'Method name', 'class' => 'grade_options method_name'])}}
                                    <span class="form-error d-none method-name-error">This field is required</span>
                                </div>
                                <div class="col-lg-5">
                                    <label for="method_description">&nbsp;&nbsp;</label>
                                    {{-- <input type="text" name="method_data[1][method_description]"  class="form-control" placeholder="Description"> --}}
                                    {{Form::select('method_data[1][method_description]',[],[], ['id'=>'method_description','placeholder'=>'Description', 'class' => 'grade_options method_description'])}}
                                </div>
                                <div class="col-lg-2">
                                    <label for="administering_method">&nbsp;&nbsp;</label>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("select#grade").change(function(){
            ...
            var gradeOptions = {
                1 : "subject", 2 : "unit_topic", 3: "method_name", 4 : "group_served",
                ...
                20 : "rubric", 21 : "method_description", 22 : "administering_method",
                23 : "homework", 24 : "homework_description", 25 : "additional_resources", 26 : "additional_description",
            };
        ...
        $('.add_diff').click(function(){
            ...
            var fieldDiffsHTML = '<div class="row standard-data pl-3 pr-3">'+
                '<div class="col-lg-2">'+
                    ...
                    '<select name="method_data['+finalData+'][method_name]" id="method-'+finalData+'" class= "d-name-'+finalData+' method-'+finalData+' method_name" placeholder="Method name" required></select>'+
                '</div>'+
                '<div class="col-lg-5">'+
                    '<label for="method_description">&nbsp;&nbsp;</label>'+
                    // '<input type="text" name="method_data['+finalData+'][method_description]" class="form-control" placeholder="Description" required>'+
                    '<select name="method_data['+finalData+'][method_description]" id="method-desc-'+finalData+'" class= "d-name-'+finalData+' method_description method-desc-'+finalData+'" placeholder="Description" required></select>'+
                    '</div>'+
                '<div class="col-lg-2">'+
                    '<label for="administering_method">&nbsp;&nbsp;</label>'+
